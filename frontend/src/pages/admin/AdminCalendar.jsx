  ...
  return (
    <Layout>
      <Box maxWidth="xl" sx={{ width: '100%', mx: 'auto' }}>
        ...
        <Grid container spacing={3} mb={4}>
          <Grid item xs={12} sm={4}>
            <Card sx={{
              ...
              position: 'relative',
              overflow: 'hidden',
              background: 'linear-gradient(135deg, rgba(26, 86, 219, 0.05) 0%, rgba(99, 102, 241, 0.05) 100%)',
              border: '1px solid rgba(26, 86, 219, 0.1)',
              transition: 'all 0.3s ease',
              '&:hover': {
                transform: 'translateY(-4px)',
                boxShadow: '0 12px 24px rgba(26, 86, 219, 0.15)'
              }
            }}>
            ...
            <Grid container spacing={3} alignItems="flex-end">
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <FormControl fullWidth variant="outlined" sx={{
                  ...
                  <Typography variant="caption" fontWeight={700} sx={{ mb: 0.75, ml: 0.5, color: '#64748b', display: 'block' }}>
                    Campus
                  </Typography>
                  <Select
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <FormControl fullWidth disabled={!filters.campus} sx={{
                  '& .MuiOutlinedInput-root': {
                    borderRadius: '12px',
                    bgcolor: '#f8fafc',
                    '&:hover': { bgcolor: '#f1f5f9' },
        ...
        <Grid container spacing={3} sx={{ alignItems: 'flex-start', flexWrap: { xs: 'wrap', sm: 'nowrap' } }}>
          {/* Calendar View */}
