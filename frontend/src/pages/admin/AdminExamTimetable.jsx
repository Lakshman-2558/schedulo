      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 shadow-sm border border-blue-100">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div className="flex-1 min-w-0">
              <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-2">Exam Timetable Preparation</h1>
              <p className="text-gray-600 text-sm sm:text-base">Prepare examination schedules for all courses and semesters department wise</p>
            </div>
            <div className="flex flex-wrap gap-2 sm:flex-nowrap">
              <button
                onClick={handleNotifyFaculty}
                disabled={sending || dates.length === 0}
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-2.5 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-2 min-h-[44px] text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="bg-white hover:bg-gray-50 text-blue-600 font-semibold py-2.5 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-2 min-h-[44px] text-sm border border-blue-200"
              >
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900">Upload Exam Timetable</h3>
              <p className="text-sm text-gray-600">Upload CSV or Excel file containing exam timetable schedule</p>
            </div>
          </div>

          {/* Exam Type Selection */}
          <div className="mb-6 p-4 sm:p-5 bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl border border-gray-200">
        ...
        {/* Timetable Table */}
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6" id="timetable-container">
          {loading ? (
            ...
            <div className="overflow-x-auto">
              {/* Exam Type Heading */}
              {displayExamType && (
                <div className="mb-8 text-center pb-6 border-b-4 border-gradient-to-r from-blue-400 to-indigo-400 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                  <h2 className="text-4xl font-extrabold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent uppercase tracking-wide">
                    {getExamTypeLabel()}
                  </h2>
                </div>
              )}
                ...
                <div className="inline-block min-w-full align-middle">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-blue-600 to-indigo-600">
                      <tr>
                        <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-white uppercase tracking-wider sticky left-0 bg-blue-600 z-10 shadow-md">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {timetableDepartments.map((dept) => (
                        <tr key={dept} className="hover:bg-blue-50 transition-colors duration-200">
                          <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-bold text-gray-900 sticky left-0 bg-white z-10 border-r-2 border-blue-200 shadow-sm">
                            {dept}
                          </td>
                          {dates.map((date) => {
                                ...
                                {deptExams.length === 0 ? (
                                  ...
                                  <div className="space-y-1.5 sm:space-y-2">
                                    {deptExams.map((exam, idx) => (
                                      <div
                                        key={exam._id || idx}
                                        className="p-2 sm:p-3 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200 hover:border-blue-400 hover:shadow-md transition-all duration-200"
                                      >
                                        ...
                                        <p className="text-[10px] sm:text-xs text-blue-600 font-semibold mt-0.5 sm:mt-1">
